	...
	<body>
		<div id="Wrapper">
			...
			<div id="Main">
				...
				<div id="Body">
					<img src="Images/FNRlogo.png" alt="some_text" class="homeimg1"/>
					<p class="Bodyparahome">
						Welcome to Fix and Run Enterprises.
					</p>
					<img src="Images/FNRlogo.png" alt="some_text" class="homeimg2"/>
				</div>
